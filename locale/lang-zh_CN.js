SnapTranslator.dict.zh_CN = { ...SnapTranslator.dict.zh_CN,
  ...
  "_ mod _": "_ mod _",
  "_ of _": "属性 _ 于 _",
  "_ of block _": "属性 _ 于积木 _",
  "_ of color _": "属性 _ 于颜色 _",
  "_ of costume _": "属性 _ 于造型 _",
  "_ of sound _": "属性 _ 于声音 _",
  "_ of text _": "属性 _ 于文本 _",
  "_ on _": "_ 在 _ 上",
  "_ to _": "_ 到 _",
  "__shout__go__": "",
  "a": "a",
  ...
  "alpha value:": "透明度:",
  "An e-mail with a link to reset your password has been sent to the address provided": "修改密码的网址已发往你的电子邮件地址",
  ...
  "balance": "声音平衡",
  "big (2x)": "大(2倍)",
  "bigger menu fonts and sliders": "使用大号菜单字体和滑动条",
  "bins": "容器",
  "Birth date:": "出生日期",
  "Bitmap": "位图",
  "block": "积木",
  ...
  "check for higher resolution, uses more computing resources": "通过更多的计算量，来支持更高的UI分辨率",
  ...
  "check to turn\nblock clicking\nsound on": "点击积木时发出声音",
  "check to turn on\n visible stepping (slow)": "勾选以在运行程序时，动态标识每一步及其相应结果",
  ...
  "Exit tutorial": "退出教程...",
  "Execute on slider change": "滑动条改变时运行脚本",
  "Expand": "子参数标签",
  ...
  "Predicate": "判断类",
  "predicate": "判断类函数",
  "Prefer empty slot drops": "优先嵌入至空白项？",
  ...
  "remove...": "删除...",
  "rename": "修改名字",
  "rename all blocks that\naccess this variable": "修改所有相关变量的名字",
  "rename all...": "修改所有相关变量的名字...",
  "rename only\nthis reporter": "仅修改积木区内变量的名字",
  "rename...": "修改名字...",
  ...
  "result": "返回值",
  "result pic...": "结果图片...",
  "Retina display support": "使用更清晰的界面？",
  "reverse": "倒序",
  "right": "右端坐标",
  "right arrow": "→",
  "ring": "环",
  ...
  "settings menu prefer empty slots hint": "返回类积木优先放在没有积木的输入项上",
  ...
  "slider": "滑动条",
  "slider max...": "滑块最大值...",
  "Slider maximum value": "滑动条的最大值",
  "slider min...": "滑块最小值...",
  "Slider minimum value": "滑动条的最小值",
  "slots": "slots(各参数类别)",
  "smaller menu fonts and sliders": "使用小号菜单字体和滑动条",
  "smallStage": "小舞台",
  "snap": "快照",
  "Snap! website": "官方社区网站",
  "Snap!Cloud": "Snap! 云端",
  ...
  "uncheck for lower resolution,\nsaves computing resources": "选择较低的UI分辨率，来节省更多计算量",
  ...
  "uncheck to allow dropped\nreporters to kick out others": "返回类积木可以替换输入项上已有的积木",
  ...
  "uncheck to suppress\nrunning scripts\nwhen moving the slider": "取消勾选后滑动滑动条时运行脚本",
  ...
  "pinhole x": "位似基准点的x坐标",
  "pinhole y": "位似基准点的y坐标",
  "clean unhatted": "清除事件之外的程序",
  "arrange scripts vertically,\nremoving all scripts\nnot attached to a hat block": "移除所有不在事件类积木下的程序\n并重新垂直排列"
};
